package com.loginPrueba.controller.tecnico;
...
import com.loginPrueba.servicios.IncidenciaService;
import com.loginPrueba.servicios.ProductoService;
import com.loginPrueba.servicios.UsuarioService;

@Controller
@RequestMapping("/tecnico/usuario")
public class UsuarioControllerTecnico {
	...
	public String submitNuevoUsuario(Usuario usuario, Model model) {
		...
		return "redirect:/tecnico/usuario/";
